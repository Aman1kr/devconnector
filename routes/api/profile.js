...
router.post('/', passport.authenticate('jwt', {session: false}), (req,res) => {
    ...
    if(typeof req.body.skills !== 'undefined'){
        profileFields.skills = req.body.skills.split(',');//req.body.(form id)
    }
...
router.post(
    ...
    (req, res) => {
      ...
      Profile.findOne({ user: req.user.id }).then(profile => {
        ...
        // Add to exp array
        profile.experience.unshift(newExp);//.push puts the data at the end and unshit in starting
...
router.post(
    ...
    (req, res) => {
      ...
      Profile.findOne({ user: req.user.id }).then(profile => {
        ...
        // Add to exp array
        profile.education.unshift(newEdu);//.push puts the data at the end and unshit in starting
